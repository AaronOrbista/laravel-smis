...
<body class="header-fixed aside-menu-fixed aside-menu-hidden login-page">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                      <li class="nav-item active">
                        <a class="nav-link" href="/">Supply Management Information System <span class="sr-only">(current)</span></a>
                      </li>
                    </ul>
